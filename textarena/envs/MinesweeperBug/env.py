...
from textarena.envs.MinesweeperBug.renderer import create_board_str

class MinesweeperBugEnv(ta.Env):
    ...
    def _generate_player_prompt(self, player_id: int, game_state: Dict[int, Any]) -> str:
        prompt = (
            ...
            f"You have {self.max_turns} turns to solve the game.\n"
